...
Pick a native-shaped template, set Focus cost / cooldown / text / icon, and write
a reviewable override document. Output always lands in the helper sandbox.
"""
...
def set_existing_special(
    ...
    *,
    ...
    require_sid(unit_sid, "unit_sid")
    notes = [
        "Edited in sandbox/. Does not mutate live Core.zip.",
        OVERLAY_REVIEW_NOTE,
